...
pub fn final_score_sum_winning_board(boards: Vec<Board>, nums: Vec<i32>) -> i32 {
    let mut b = boards;
...
#[cfg(test)]
mod test {
    use super::{ Board, final_score_sum_winning_board };
    ...
    #[test]
    fn test_score_sum_winning_board() {
        ...
        let nums = vec![7,4,9,5,11,17,23,2,0,14,21,24,10,16,13,6,15,25,12,22,18,20,8,19,3,26,1];
        assert_eq!(4512, final_score_sum_winning_board(boards, nums));
    }
}